...
pub fn get_tasks(limit: Option<i32>, offset: Option<i32>) -> Json<serde_json::Value> {
...
pub fn filter_tasks(param: Option<Json<RequestParam<TaskFilter>>>) -> Json<serde_json::Value> {
