...
-- 向 users 表插入示例数据
INSERT INTO user_table (username, role, email, password, fullname, avatar_url, bio, mobile_phone)
VALUES
...
ALTER TABLE "user_table" ADD CONSTRAINT "role" FOREIGN KEY ("role") REFERENCES "role_table" ("role_id") ON DELETE CASCADE ON UPDATE CASCADE;
